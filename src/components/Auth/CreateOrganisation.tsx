    ...
    <Container>
      ...
      <Wrapper>
        <Card onSubmit={onSubmit}>
          ...
          <Title>
            <TitleHead>Adding Organisation to Our Database </TitleHead>
            <TitleSub>
              Adding Organisations that has been ratified according to the
              policies of <span>NYCN AJIF Chapter</span>, This gives members of
              this organisation to voted for and to vote!
            </TitleSub>
          </Title>
          <br />
          <br />
