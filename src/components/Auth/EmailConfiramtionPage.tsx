...
//  http://localhost:3000/api/user/<%= id %>/token
        ...
        <Card>
          ...
          <Title>
            ...
            <TitleSub>
              ...
              to register an Account with us, Please go check it and{" "}
              <span>follow the instructions carefully</span> to complete your
